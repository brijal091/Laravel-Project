...
<head>
  ...
  <link rel="stylesheet" href="{!! asset('theam/vendors/css/vendor.bundle.base.css') !!}">
  <!-- endinject -->
  <!-- plugin css for this page -->
  <link rel="stylesheet" href="{!! asset('theam/vendors/select2/select2.min.css') !!}">
  <link rel="stylesheet" href="{!! asset('theam/vendors/select2-bootstrap-theme/select2-bootstrap.min.css') !!}">
...
<body>
        ...
        <ul class="navbar-nav mr-lg-2">
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{!! asset('theam/images/faces/face5.jpg') !!}" alt="profile"/>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link"  href="/category" aria-expanded="false" aria-controls="form-elements">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="error">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="/measurement"> Measurement Unit</a></li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Copyright © 2022 Agriculture Hub. All rights reserved.</span>
                    </div>
                </div>    
            </div>        
        </footer>
  ...
  <script src="{!! asset('theam/vendors/typeahead.js/typeahead.bundle.min.js') !!}"></script>
  <script src="{!! asset('theam/vendors/select2/select2.min.js') !!}"></script>
  <!-- End plugin js for this page -->
  <!-- Custom js for this page-->
  <script src="{!! asset('theam/js/file-upload.js') !!}"></script>
  <script src="{!! asset('theam/js/typeahead.js') !!}"></script>
  <script src="{!! asset('theam/js/select2.js') !!}"></script>
