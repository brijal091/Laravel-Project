...
<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="/updatecategory" enctype="multipart/form-data">
                    @csrf
                     <input type="hidden" value="{{$cat->categoryid}}" name="id">
                    <div class="form-group">
                      <label for="exampleInputName1">Cateogry Name</label>
                      <input type="text" class="form-control" value="{{$cat->categoryname}}" name="t1" placeholder="Cateogry Name">
                    </div>
                    <div class="form-group">
                      ...
                      <img src='{!! asset($cat->categoryimage) !!}' width="50" height="50">
                    </div>
